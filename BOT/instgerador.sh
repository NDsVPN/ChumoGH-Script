...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/NDsVPN/VPSbot/main/TeleBotGen/Control/Control-Bot")
...
wget https://raw.githubusercontent.com/NDsVPN/ChumoGH-Script/main/BOT/gerador/gerar.sh &>/dev/null
